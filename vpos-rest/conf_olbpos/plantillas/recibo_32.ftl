...
se realiza una distincion con LDI debido a que la longitud del tipo de servicio es de 29 caractes 
sumados a la cadena "Tipo: " supera los 32 caracteres    
-->
...
<#if transaccion.tipo == "Larga Distancia Internacional">
Tipo de Servicio: LDI
${transaccion.tipo!""}
<#else>
...
Consulta nuestros planes y 
servicios en www.movistar.com.ve
y actívalos por Mi Movistar.
...
comuníquese al número de 
acceso, ingrese el pin 
comprado y posteriormente 
el número al cual desea 
llamar.

</#if>
<#if simpletv == 1>

Simple informa que tu 
recarga será efectiva en un
lapso máxima de 24h.
